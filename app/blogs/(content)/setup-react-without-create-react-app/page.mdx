...
export default function MDXPage({ children }) {
  return (
    <>
      <span className="mb-1 block text-4xl">{metadata.title}</span>
...
Open [http://localhost:5000](http://localhost:5000), and there it is—**Hello world in React!** No more errors, no more tears. You’ve survived the React setup and now you knwo why we use the create-react-app. 🚀
